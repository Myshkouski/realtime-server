...
let UpgradeContext = _decorate([requestDecorator, withSocket], function (_initialize, _Context) {
  class UpgradeContext extends _Context {
    constructor(...args) {
      super(...args);
...
let ClientContext = _decorate([requestDecorator, withSocket, withClient], function (_initialize2, _Context2) {
  class ClientContext extends _Context2 {
    constructor(...args) {
      super(...args);
